!(function (a) {
    ...
    function i() {
        a('.header-image').imagesLoaded({ background: !0 }, function () {
        ...
        a('.gallery').each(function () {
            ...
            e.append('<div class="gallery__wrap"></div>'),
                ...
                e.find('.gallery__wrap img').each(function () {
                    ...
                    a(this)
                        .wrapAll(
                            '<div class="gallery__item"><a href="' + e + '" class="gallery__item__link"></div></div>'
                        )
                        .appendTo();
                }),
            ...
            a('.single iframe').each(function () {
                if (a(this).attr('src').indexOf('youtube') >= 0 || a(this).attr('src').indexOf('vimeo') >= 0) {
                    ...
                    a(this).wrapAll(
                        '<div class="video-wrap"><div class="video" style="padding-bottom:' + t + '%;"></div></div>'
                    );
                }
            }),
    ...
    o.Adapter.bind(window, 'statechange', function () {
        ...
        a('body').addClass('loading'),
            a('.page-loader').load(l.hash + ' .page__content', function () {
                setTimeout(function () {
                    a('body, html').animate({ scrollTop: 0 }, 0),
                        ...
                        (t = a('.page__content').attr('data-page-title')),
                        (document.title = t);
                    var o = a('.page__content').attr('data-image');
                    i(),
                        o !== n &&
                            ((n = o),
                            a('.header-image:not(.header-image--on)').css('background-image', 'url(' + n + ')'),
                            a('.header-image:not(.header-image--on)').addClass('header-image--switch'),
                            a('.header-image--switch').imagesLoaded({ background: !0 }, function () {
                                a('.header-image--on').removeClass('header-image--on'),
                                    a('.header-image--switch').addClass('header-image--on'),
                                    a('.header-image--switch').removeClass('header-image--switch');
                            }));
                }, 400);
            });
    }),
        a('body').hasClass('ajax-loading') &&
            a(document).on('click', 'a', function (n) {
                n.preventDefault();
                ...
                i.indexOf('tel:') >= 0
                    ...
                    : a(this).is('.gallery__item__link') ||
                      (i.indexOf('http') >= 0 ? window.open(i, '_blank') : ((e = i), o.pushState(null, t, i)));
            }),
        i(),
        ...
        a(document).on('submit', '#contact-form', function (e) {
            ...
            '' === t.val() && t.closest('.contact-form__item').addClass('contact-form__item--error'),
                ...
                ('' !== t.val() && '' !== o.val() && '' !== n.val() && 0 === i.val().length) || e.preventDefault();
        });
})(jQuery);
